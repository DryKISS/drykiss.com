...
[Digiti Portfolio](https://www.digiti.be/projects)
https://www.brilliantbasics.com/#Makinglifesimplybetter
...
## Social
## @see https://www.facebook.com/DryKISSLtd/
## @see https://plus.google.com/u/1/b/115715381033932443138/+Drykiss
## @see https://www.linkedin.com/company/drykiss-ltd

- [ ] Create Instagram account
- [ ] Admin Facebook social page
    - [ ] Connect an Instagram account and link it
- [ ] Sign up to Feed burner for the blog elements
- [ ] Create Twitter for DryKISS
...
## @see http://seorch.eu/
## @see http://ogp.me/
## @see http://json-ld.org/ over MicroData
## Title = 57 chars max
## Desc  = 160 chars max

- [ ] Automatically check the text count of meta data on the middleman build
    - @see http://bretthard.in/post/jekyll-and-seo-optimization
...
## Our work
## Image sizes : 360x360 - 1:1
## Image sizes : 360x270 - 4:3
## Image sizes : 360x203 - 16:9

Uses the MixItUp library to present the portfolio blog posts in a filterable
manner.

- General
    - [ ] Replace the mixitup library with something from NPM
