  ...
  return (
    <Page brand={Brand} meta={meta}>
      ...
      <Row>
        ...
        <Column md={3}>
          <p>
            <strong>ARCHITECT:</strong> DryKISS will draft a user centric development approach which
        ...
        <Column md={3}>
          <p>
            <strong>CRAFT:</strong> Our crafting is all about rapid feature completion. We want the
            user to test a story as quickly as possible.
          </p>
          <p>
      ...
      <Row>
        <Column md={4}>
          ...
          <p>
            ...
            of your products, the happiness of your customers and the success of your business.
          </p>
        </Column>
