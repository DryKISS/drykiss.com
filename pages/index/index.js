    ...
    <>
      ...
      <StyledServices>
        <Container>
          ...
          <Heading content='We pride ourselves on offering a full-service, economic and future technology approach.' tag='h5' />
          <Image title='Services' alt='Services' src='../static/services/services.jpg' />
          <Row>
            <Column md={12} lg={4}>
              <Heading content='User Experience' tag='h6' />
              <p>We help brands create valuable experiences across digital channels by focusing on
