...
export default () => {
  ...
  return (
    <Page heading='Careers - Senior React Developer' meta={meta}>
      ...
      <List>
        <span>Own one of our project SDLC.</span>
        <span>
      ...
      <List>
        <span>4+ years front end developemnt experience.</span>
        <span>2+ years developing with React</span>
        <span>Ability to write high-performance, reusable code for UI components.</span>
        <span>
          Export in all kinds of testing best practices; writing clean and maintainable code.
        </span>
        <span>Experienced in CI including git, aws, docker, etc.</span>
        <span>
      ...
      <List>
        <span>Office in City Center</span>
        <span>Training budget, including language lessons are available.</span>
        <span>10% time, we will work on your ideas with you, using DryKISS stack.</span>
        <span>Flexible work time, we just like to get the job done.</span>
      </List>

      <Heading content='Offer Details' tag='h2' />

      <List>
        <span>Able to communicate in English</span>
        <span>Training budget, including language lessons are available.</span>
        <span>Contract Salary: Based on experience.</span>
      </List>
    </Page>
  )
}
