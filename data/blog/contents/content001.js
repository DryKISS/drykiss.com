const content =
`<p>I was always curious about coding. My background was business and event planning; nothing to do with coding at all. In the summer of 2019, I joined a 9-week Bootcamp to learn the basics of becoming a developer. A decision that resulted in a lack of sleep, my computer being permanently on 24/7 (switched from Sublime to browser to Sublime and back again), and my fingers hoovering constantly over Control+Shift+C at every page like a coffee addict waiting to grab that next shot. For our final project, I spent 3 weeks eating, breathing and sleeping code. But I loved it!	</p>
