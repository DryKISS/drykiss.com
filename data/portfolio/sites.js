...
export const PORTFOLIO_SITES = [
  ...
  },
  {
    ...
    author: 'Ian Warner',
    client: 'beep-taxi',
    cover: '/images/portfolio/beep-taxi/beep-taxi/hero.png',
    description: `
      <p>
    ...
    links: [
      {
        href: 'http://www.getreading.co.uk/news/local-news/now-you-can-beep-you-4263837',
        label: 'Beep Taxi'
      }
    ],
    meta: {
  ...
  },
  {
    ...
    author: 'Ian Warner',
    client: 'deliveroo',
    cover: '/images/portfolio/deliveroo/excuse-generator/hero.png',
    description: `
      <p>
    ...
    links: [
      {
        href: 'http://excuse-generator.com/',
        label: 'Deliveroo Excuse generator'
      }
    ],
    meta: {
    ...
    outcome: ['Delivered on time', 'Many change requests handled'],
  ...
  },
  {
    ...
    author: 'Ian Warner',
    client: 'drykiss',
    cover: '/images/portfolio/drykiss/greentouch-pi/greentouch-contact.png',
    description: `
      <p>
      ...
      <p>
        ...
        business currently was, understanding hers', the staff and clientèle's pain points.
      </p>
    ...
    `,
    duration: ['5 days research and reporting', '5 days development'],
    links: [
      {
        href: 'http://greentouchpi.com/',
        label: 'Greentouch PI'
      }
    ],
    meta: {
    ...
    outcome: [
      'Page 1 on Google for search phrase "Massage Wimbledon"',
      'Business up 600% since launch',
      '4x the original staff levels'
    ],
    slug: 'greentouch-pi',
    tasks: [
      'Keyword research',
      ...
      'Social pages, Facebook, Google and Wahanda'
    ],
    team: ['Ian Warner - Technical lead', 'May Tran - Digital Marketing'],
    title: 'Greentouch PI',
    type: 'site'
  },
  {
    ...
    links: [
      {
        href: 'http://fentonbutcher.co.uk/news/',
        label: 'IBM - Pivot'
      },
      {
        href: 'https://www.youtube.com/watch?v=2wN-vgbFnoc',
        label: 'IBM iX London Studio Video'
      },
      {
        href: 'http://studios.ibm.com/',
        label: 'IBM Studios'
      },
      {
        href: 'https://www-03.ibm.com/press/uk/en/pressrelease/46148.wss',
        label: 'IBM London'
      }
    ],
    meta: {
    ...
    team: [
      ...
      'Matthew Parish - AngularJS Developer',
      'Fenton Butcher - UX',
      "Leila d'Angelo - Content",
      'Patrick Odey - Product Owner',
      'Krishna Chodipilli - Scrum Master'
    ],
    title: 'IBM Pivot',
    type: 'site'
  },
  {
    ...
    author: 'Ian Warner',
    client: 'minesoft',
    cover: '/images/portfolio/minesoft/minesoft-thesaurus/minesoft-chemical.png',
    description: `
      <p>
    ...
    `,
    duration: ['40 days development'],
    links: [
      {
        href: 'http://minesoft.com/',
        label: 'Minesoft'
      },
      {
    ...
    outcome: ['Delivered on time', 'Deployed successfully'],
    slug: 'minesoft-thesaurus',
    tasks: [
      'APIs',
